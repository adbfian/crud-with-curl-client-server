...
<body>
    <div class="container page">
        ...
        <button class="btn btn-primary btn-bd-primary" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Tambah Data</button>
        <button class="btn btn-default btn-bd-default" onclick="reload_table()"><i class="glyphicon glyphicon-refresh"></i> Reload</button>
        <br />
        <br />
